...
torchrun --nproc_per_node=1 \
    ...
    --output_dir /group/40064/johnbli/Code/Deepseek/open-r1-multimodal/checkpoints/Qwen2-VL-7B-cold-0.2-continue-cold-segreward-all \
    --model_name_or_path /group/40064/johnbli/Code/Deepseek/open-r1-multimodal/checkpoints/Qwen2-VL-7B-cold-0.2-continue-cold-segreward-all \
    --dataset_name /group/40064/johnbli/Data/GMNER/data/twitter2015/test.json \
