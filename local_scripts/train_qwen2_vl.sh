...
torchrun --nproc_per_node=8 \
    ...
    --model_name_or_path /group/40064/johnbli/LLM-based-models/Qwen/Qwen2-VL-2B-Instruct \
    --dataset_name /group/40064/johnbli/Code/Deepseek/open-r1-multimodal/datasets/MM-Eureka-Dataset/train-00000-of-00001.parquet \
